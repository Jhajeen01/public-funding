...
const FormField = ({labelText, isTextArea, placeholder, inputType, value, handleChange}) => {
  return (
    <label className='flex-1 w-full flex flex-col'>
        {labelText && (
            <span className='font-epilogue font-medium tex-[14px] leading-[22px] text-[#808191] mb-[10px]'
            >{labelText}</span>
        )}
        {isTextArea ?(
            <textarea
